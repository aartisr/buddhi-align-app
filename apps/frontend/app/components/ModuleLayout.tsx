        ...
        <ul className="app-mobile-nav-list">
          <li className="app-mobile-nav-quick-links">
            ...
            <CommunityAwareLink
              ...
              onClick={closeNav}
              aria-current={isPathActive("/community") ? "page" : undefined}
            >
              <span aria-hidden>💬</span>
...
function ModuleLayoutView({
  ...
  return (
    <div className="app-shell relative font-sans">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-9999 focus:px-4 focus:py-2 focus:rounded-lg focus:bg-(--primary) focus:text-(--on-primary) focus:font-semibold focus:text-sm"
      >
        {t("nav.skipToMain")}
      </a>
